...
_INIT;
  ...
  if (isset($_SESSION['user'])){
    $user     = $_SESSION['user'];
    $loggedin = TRUE;
    $userstr  = "Logged in as: ". stripslashes($user);
  }
  else $loggedin = FALSE;
  ...
  <body>
    <div data-role='page'>
      <div data-role='header'>
        <div id='logo' class='center'>$title</div>
  ...
  if ($loggedin){
    echo <<<_LOGGEDIN
        <div class='center'>
          ...
          <a data-role='button' data-inline='true' data-icon='mail'
            data-transition="slide" href='msgboard.php?r=$randstr'>Post</a>
          <a data-role='button' data-inline='true' data-icon='edit'
            data-transition="slide" href='chgpasswd.php?r=$randstr'>Change Password</a>
